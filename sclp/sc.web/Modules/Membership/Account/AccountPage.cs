namespace sc.Membership.Pages {
    ...
    public partial class AccountController : Controller {
        ...
        private ActionResult Error(string message) => View(MVC.Views.Errors.ValidationError, new ValidationError(Texts.Validation.InvalidResetToken));
