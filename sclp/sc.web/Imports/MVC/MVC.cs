...
namespace MVC
{
    public static class Views
    {
        ...
        public static class Default
        {
            ...
            {
                public const string MaterialKindsIndex = "~/Modules/Default/MaterialKinds/MaterialKindsIndex.cshtml";
            }

            public static class Materials
            {
                public const string MaterialsIndex = "~/Modules/Default/Materials/MaterialsIndex.cshtml";
            }

            public static class TextbookContent
            {
                public const string TextbookContentIndex = "~/Modules/Default/TextbookContent/TextbookContentIndex.cshtml";
            }

            public static class Textbooks
            {
                public const string TextbooksIndex = "~/Modules/Default/Textbooks/TextbooksIndex.cshtml";
            }
        }
